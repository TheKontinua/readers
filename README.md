...
4. Locate the config file in the `.AWS folder` (location varies based on operating system, usually in the home directory). Ask the team for the AWS Elastic Beanstalk credentials
    ...
    - The current state of the project after deployment can be viewed here: [mentoris.eba-tsm5gnpk.us-west-2.elasticbeanstalk.com](mentoris.eba-tsm5gnpk.us-west-2.elasticbeanstalk.com)
