# Generated by Django 4.2.5 on 2024-02-15 17:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('volume_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='mentapp.volume')),
            ],
        ),
        migrations.CreateModel(
            name='Quiz_Rendering',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('blob_key', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='mentapp.blob')),
                ('support', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='mentapp.support')),
            ],
            options={
                'indexes': [models.Index(fields=['support', 'lang_code', 'dialect_code'], name='support_attachment_comp_pkey')],
                'unique_together': {('support', 'lang_code', 'dialect_code')},
            },
        ),
        migrations.CreateModel(
