# Generated by Django 5.0.1 on 2024-03-15 03:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creator', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='mentapp.user')),
            ],
        ),
        migrations.CreateModel(
            name='Question_Loc',
            fields=[
                ...
                ('approver', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='approved_chapter_loc', to='mentapp.user')),
                ('creator', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='created_chapter_loc', to='mentapp.user')),
            ],
        ),
        migrations.CreateModel(
            name='Quiz',
            fields=[
                ...
                ('chapter', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='mentapp.chapter')),
                ('creator_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='mentapp.user')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_verified', models.BooleanField(default=False)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='emails', to='mentapp.user', verbose_name='User')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            options={
                'indexes': [models.Index(fields=['question', 'filename', 'lang_code', 'dialect_code'], name='question_attachment_comp_pkey')],
        ...
        migrations.CreateModel(
            ...
            options={
                'indexes': [models.Index(fields=['quiz', 'question'], name='quiz_question_comp_pkey')],
        ...
        migrations.CreateModel(
            ...
            options={
                'indexes': [models.Index(fields=['quiz', 'support'], name='quiz_support_comp_pkey')],
        ...
        migrations.CreateModel(
            ...
            options={
                'indexes': [models.Index(fields=['support', 'lang_code', 'dialect_code', 'blob_key'], name='support_attachment_comp_pkey')],
